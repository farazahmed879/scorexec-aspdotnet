...
{
    /// <inheritdoc />
    public partial class updatedversion7 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Organizor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizorContact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    NumberOfGroup = table.Column<int>(type: "int", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BattingStyleId = table.Column<int>(type: "int", nullable: true),
                    BowlingStyleId = table.Column<int>(type: "int", nullable: true),
                    PlayerRoleId = table.Column<int>(type: "int", nullable: true),
                    DOB = table.Column<long>(type: "bigint", nullable: true),
                    IsGuestorRegistered = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DeleterUserId = table.Column<long>(type: "bigint", nullable: true),
                    DeletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatingTime = table.Column<long>(type: "bigint", nullable: true),
                    UpdatingTime = table.Column<long>(type: "bigint", nullable: true),
                    DeletingTime = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalInnings = table.Column<int>(type: "int", nullable: true),
                    TotalNotOut = table.Column<int>(type: "int", nullable: true),
                    GetBowled = table.Column<int>(type: "int", nullable: true),
                    GetHitWicket = table.Column<int>(type: "int", nullable: true),
                    GetLBW = table.Column<int>(type: "int", nullable: true),
                    GetCatch = table.Column<int>(type: "int", nullable: true),
                    GetStump = table.Column<int>(type: "int", nullable: true),
                    GetRunOut = table.Column<int>(type: "int", nullable: true),
                    TotalBatRuns = table.Column<int>(type: "int", nullable: true),
                    TotalBatBalls = table.Column<int>(type: "int", nullable: true),
                    TotalFours = table.Column<int>(type: "int", nullable: true),
                    TotalSixes = table.Column<int>(type: "int", nullable: true),
                    NumberOf50s = table.Column<int>(type: "int", nullable: true),
                    NumberOf100s = table.Column<int>(type: "int", nullable: true),
                    BestScore = table.Column<int>(type: "int", nullable: true),
                    TotalOvers = table.Column<float>(type: "real", nullable: true),
                    TotalBallRuns = table.Column<int>(type: "int", nullable: true),
                    TotalWickets = table.Column<int>(type: "int", nullable: true),
                    TotalMaidens = table.Column<int>(type: "int", nullable: true),
                    FiveWickets = table.Column<int>(type: "int", nullable: true),
                    DoBowled = table.Column<int>(type: "int", nullable: true),
                    DoHitWicket = table.Column<int>(type: "int", nullable: true),
                    DoLBW = table.Column<int>(type: "int", nullable: true),
                    DoCatch = table.Column<int>(type: "int", nullable: true),
                    DoStump = table.Column<int>(type: "int", nullable: true),
                    OnFieldCatch = table.Column<int>(type: "int", nullable: true),
                    OnFieldStump = table.Column<int>(type: "int", nullable: true),
                    OnFieldRunOut = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchOvers = table.Column<int>(type: "int", nullable: false),
                    ...
                    TossWinningTeam = table.Column<long>(type: "bigint", nullable: true),
                    DateOfMatch = table.Column<long>(type: "bigint", nullable: true),
                    HomeTeamId = table.Column<long>(type: "bigint", nullable: false),
                    OppponentTeamId = table.Column<long>(type: "bigint", nullable: false),
                    ProfileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MatchTypeId = table.Column<int>(type: "int", nullable: false),
                    EventStage = table.Column<int>(type: "int", nullable: true),
                    PlayerOTM = table.Column<long>(type: "bigint", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroundName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OpponentTeam = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    WicketNo = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroundId = table.Column<long>(type: "bigint", nullable: true),
                    EventId = table.Column<long>(type: "bigint", nullable: true),
                    UmpireId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Inning = table.Column<int>(type: "int", nullable: true),
                    IsLiveOrMannual = table.Column<int>(type: "int", nullable: true),
                    ScoringBy = table.Column<int>(type: "int", nullable: false),
                    MatchId = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    WicketNo = table.Column<int>(type: "int", nullable: false),
                    PlayerOutId = table.Column<long>(type: "bigint", nullable: true),
                    StartTime = table.Column<int>(type: "int", nullable: true),
                    EndTime = table.Column<int>(type: "int", nullable: true),
                    Extras = table.Column<int>(type: "int", nullable: true),
                    Four = table.Column<int>(type: "int", nullable: true),
                    Six = table.Column<int>(type: "int", nullable: true),
                    Player1Id = table.Column<long>(type: "bigint", nullable: false),
                    Player1Runs = table.Column<int>(type: "int", nullable: false),
                    Player1Balls = table.Column<int>(type: "int", nullable: false),
                    Player1Six = table.Column<int>(type: "int", nullable: true),
                    Player1Four = table.Column<int>(type: "int", nullable: true),
                    Player2Id = table.Column<long>(type: "bigint", nullable: false),
                    Player2Runs = table.Column<long>(type: "bigint", nullable: false),
                    Player2Balls = table.Column<long>(type: "bigint", nullable: false),
                    Player2Six = table.Column<int>(type: "int", nullable: true),
                    Player2Four = table.Column<int>(type: "int", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false),
                    IsStriker = table.Column<bool>(type: "bit", nullable: false),
                    IsBowling = table.Column<bool>(type: "bit", nullable: false),
                    Position = table.Column<int>(type: "int", nullable: true),
                    MatchId = table.Column<long>(type: "bigint", nullable: false),
                    BowlerId = table.Column<long>(type: "bigint", nullable: true),
                    Bat_Runs = table.Column<int>(type: "int", nullable: true),
                    Bat_Dots = table.Column<int>(type: "int", nullable: true),
                    Bat_Balls = table.Column<int>(type: "int", nullable: true),
                    HowOutId = table.Column<int>(type: "int", nullable: true),
                    Ball_Runs = table.Column<int>(type: "int", nullable: true),
                    Ball_Dots = table.Column<int>(type: "int", nullable: true),
                    Overs = table.Column<float>(type: "real", nullable: true),
                    Wickets = table.Column<int>(type: "int", nullable: true),
                    Stump = table.Column<int>(type: "int", nullable: true),
                    Catches = table.Column<int>(type: "int", nullable: true),
                    Maiden = table.Column<int>(type: "int", nullable: true),
                    RunOut = table.Column<int>(type: "int", nullable: true),
                    Four = table.Column<int>(type: "int", nullable: true),
                    Six = table.Column<int>(type: "int", nullable: true),
                    Fielder = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    IsPlayedInning = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Overs = table.Column<float>(type: "real", nullable: true),
                    Wickets = table.Column<int>(type: "int", nullable: true),
                    Wideballs = table.Column<int>(type: "int", nullable: true),
                    NoBalls = table.Column<int>(type: "int", nullable: true),
                    Byes = table.Column<int>(type: "int", nullable: true),
                    LegByes = table.Column<int>(type: "int", nullable: true),
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    MatchId = table.Column<long>(type: "bigint", nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
